...
-(void)setBottomView{
    UILabel   * lab = [XYUIKit labelWithBackgroundColor:KClearColor textColor:[UIColor lightGrayColor] textAlignment:NSTextAlignmentCenter numberOfLines:1 text:@"会员到期日：2018-05-30" fontSize:13];
