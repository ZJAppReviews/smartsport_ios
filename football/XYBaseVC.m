...
-(void)getInfo{
    ...
    [RequestManager requestWithType:HttpRequestTypePost urlString:@"http://smapi.baibaobike.com/authed/oauth.html" parameters:@{@"imei":UDID,@"code":strEnRes}
                       successBlock:^(id response) {
                           ...
                           [store  putObject:dic  withId:@"urlInfo" intoTable:@"person"];
                           
                           //  [store getObjectById:@"urlInfo" fromTable:@"person"];
...
-(void)registToken{
    ...
    [RequestManager requestWithType:HttpRequestTypePost
                       ...
                       successBlock:^(id response) {
                           NSLog(@"response==%@",response);
                           NSMutableDictionary *dic  = [NSMutableDictionary   dictionaryWithDictionary:[store getObjectById:@"urlInfo" fromTable:@"person"]];
