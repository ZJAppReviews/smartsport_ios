...
-(void)setSubview{
    if(self.arr.count==0){
        [self showPlaceholderViewWithImage:nil message:@"没有赛程" buttonTitle:nil centerOffsetY:0 onSuperView:self.view];
        return;
    }
    [self setLine];
    ...
    self.segmentedControl = [self setSegframe:CGRectMake(0, 64, KScreenWidth, kSegmentedControlHeight) titleArr:self.arrName space:90];
