...
- (IBAction)clinckInfo:(UIButton *)sender {
    if(sender.tag==0){
        ...
        men.delegate=self;
        men.tag=1;
        NSDictionary *dic1 = [NSDictionary dictionaryWithObjectsAndKeys:@"0号",@"name",@"0",@"cellID",  nil];
        NSDictionary *dic2 = [NSDictionary dictionaryWithObjectsAndKeys:@"1号",@"name",@"1",@"cellID",  nil];
        NSDictionary *dic3 = [NSDictionary dictionaryWithObjectsAndKeys:@"2号",@"name",@"2",@"cellID",  nil];
        NSDictionary *dic4 = [NSDictionary dictionaryWithObjectsAndKeys:@"3号",@"name",@"2",@"cellID",  nil];
        NSDictionary *dic5 = [NSDictionary dictionaryWithObjectsAndKeys:@"4号",@"name",@"2",@"cellID",  nil];
        NSDictionary *dic6 = [NSDictionary dictionaryWithObjectsAndKeys:@"5号",@"name",@"2",@"cellID",  nil];
        NSDictionary *dic7 = [NSDictionary dictionaryWithObjectsAndKeys:@"6号",@"name",@"2",@"cellID",  nil];
